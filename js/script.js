...
// Add base URL detection for GitHub Pages
...
async function getSongs(folder) {
    try {
        ...
        document.getElementById("contd").appendChild(div);
        ...
        for (const song of songs) {
            songUL.innerHTML += `<li>
                <img class="invert" width="34" src="${baseURL}/img/music.svg" alt="">
                <div class="info">
                ...
                <div class="playnow">
                    <span>Play Now</span>
                    <img class="invert" src="${baseURL}/img/play.svg" alt="">
                </div>
            </li>`;
        }
...
async function main() {
    try {
        await getSongs(`${baseURL}/songs/emotional`);
